...
const OperationBtn = ({ innerContent, onClick, className }: { innerContent: React.ReactNode; onClick?: () => void; className?: string }) => (
  <div
    className={`relative box-border flex items-center justify-center h-7 w-7 p-0.5 rounded-lg bg-green-100 cursor-pointer text-gray-500 hover:text-gray-800 ${className ?? ''}`}
      ...
      <div className='flex items-start'>
        ...
        <div className={`${s.answerWrap}`}>
          <div className={`${s.answer} relative text-sm text-gray-900`}>
            <div className={'ml-2 py-3 px-4 bg-gray rounded-tr-2xl rounded-b-2xl'}>
